...
// Use require.resolve to find language-service regardless of whether npm hoisted it
// or installed it nested inside this package's node_modules.
// Main CJS entry is at dist/cjs/src/index.js — go up 3 dirs to reach dist/.
