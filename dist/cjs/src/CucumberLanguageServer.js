...
exports.CucumberLanguageServer = void 0;
const language_service_1 = require("@cucumber/language-service");
const vscode_languageserver_1 = require("vscode-languageserver");
const buildStepTexts_js_1 = require("./buildStepTexts.js");
const Files_js_1 = require("./Files.js");
const fs_js_1 = require("./fs.js");
const getStepDefinitionSnippetLinks_js_1 = require("./getStepDefinitionSnippetLinks.js");
...
class CucumberLanguageServer {
    constructor(connection, documents, parserAdapter, makeFiles, onReindexed) {
        this.connection = connection;
        this.documents = documents;
        this.makeFiles = makeFiles;
        this.onReindexed = onReindexed;
        ...
        connection.onInitialize((params) => __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_a = params.capabilities.workspace) === null || _a === void 0 ? void 0 : _a.configuration) {
                connection.onDidChangeConfiguration((params) => {
                    ...
                    // params.settings may be null/undefined or may not have the expected shape
                    // (depends on the client). Always fetch settings via getSettings() to ensure
                    // we get well-formed config rather than risking a runtime error on undefined.
                    const settings = ((_a = params.settings) === null || _a === void 0 ? void 0 : _a.features) != null && ((_b = params.settings) === null || _b === void 0 ? void 0 : _b.glue) != null
                        ? params.settings
                        : undefined;
            ...
            if ((_d = params.capabilities.textDocument) === null || _d === void 0 ? void 0 : _d.semanticTokens) {
                ...
                connection.languages.semanticTokens.on((semanticTokenParams) => {
                    ...
                    return (0, language_service_1.getGherkinSemanticTokens)(gherkinSource, (((_a = this.expressionBuilderResult) === null || _a === void 0 ? void 0 : _a.expressionLinks) || []).map((l) => l.expression));
                });
            }
            else {
            ...
            if ((_g = (_f = (_e = params.capabilities.textDocument) === null || _e === void 0 ? void 0 : _e.completion) === null || _f === void 0 ? void 0 : _f.completionItem) === null || _g === void 0 ? void 0 : _g.snippetSupport) {
                connection.onCompletion((params) => {
                    ...
                    if (!doc)
                        return [];
                    const gherkinSource = doc.getText();
                    return (0, language_service_1.getGherkinCompletionItems)(gherkinSource, params.position, this.searchIndex).slice();
                });
                ...
                connection.onCodeAction((params) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (this.expressionBuilderResult) {
                        ...
                        for (const link of links) {
                            const languageName = (0, fs_js_1.getLanguage)((0, Files_js_1.extname)(link.targetUri));
                            if (!languageName) {
                            ...
                            const createFile = !(yield this.files.exists(link.targetUri));
            ...
            if ((_k = params.capabilities.textDocument) === null || _k === void 0 ? void 0 : _k.definition) {
                connection.onDefinition((params) => {
                    ...
                    if (!doc || !this.expressionBuilderResult)
                        return [];
                    const gherkinSource = doc.getText();
                    return (0, language_service_1.getStepDefinitionLocationLinks)(gherkinSource, params.position, this.expressionBuilderResult.expressionLinks);
                });
            }
            else {
            ...
            if ((_l = params.capabilities.textDocument) === null || _l === void 0 ? void 0 : _l.documentSymbol) {
                connection.onDocumentSymbol((params) => {
                    ...
                    if (!doc)
                        return [];
                    const gherkinSource = doc.getText();
                    const symbol = (0, language_service_1.getGherkinDocumentFeatureSymbol)(gherkinSource);
            ...
            try {
                ...
                if (config && config.length === 1) {
                    ...
                    return {
                        ...
                        snippetTemplates: (settings === null || settings === void 0 ? void 0 : settings.snippetTemplates) || {},
                    };
                }
                else {
    ...
    reindex(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gherkinSources = yield (0, fs_js_1.loadGherkinSources)(this.files, settings.features);
            ...
            const glueSources = yield (0, fs_js_1.loadGlueSources)(this.files, settings.glue);
            ...
            try {
                ...
                const suggestions = (0, language_service_1.buildSuggestions)(this.expressionBuilderResult.registry, stepTexts, expressions);
...
exports.CucumberLanguageServer = CucumberLanguageServer;
