...
export const glueExtByLanguageName = {
...
export function loadGlueSources(files, globs) {
...
export function loadGherkinSources(files, globs) {
    return __awaiter(this, void 0, void 0, function* () {
        return loadSources(files, globs, new Set(['.feature']), { '.feature': 'gherkin' });
    });
}
export function findUris(files, globs) {
    return __awaiter(this, void 0, void 0, function* () {
