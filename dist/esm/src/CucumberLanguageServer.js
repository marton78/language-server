...
export class CucumberLanguageServer {
    ...
    reindex(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gherkinSources = yield loadGherkinSources(this.files, settings.features);
            ...
            const glueSources = yield loadGlueSources(this.files, settings.glue);
            ...
            try {
                ...
                const suggestions = buildSuggestions(this.expressionBuilderResult.registry, stepTexts, expressions);
